...
""", reply_markup=markup)
    ...
    if work_channel1 != '999':
        ...
        await posting_o(linki, second_start, list_otvetok, second_work, num)

    else:
        await posting_o(link_c, second_start, list_otvetok, second_work, num)
